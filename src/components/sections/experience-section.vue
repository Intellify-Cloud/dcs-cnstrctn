  ...
  <section id="experience" v-reveal class="bg-surface py-stack-lg">
    <div class="mx-auto max-w-container-max px-margin-mobile sm:px-margin-large-mobile md:px-margin-tablet lg:px-margin-desktop">
      ...
      <div class="grid items-stretch gap-gutter lg:grid-cols-[5fr_3fr_2fr]">
        ...
        <article class="glass-edge flex flex-col rounded-[5px] bg-primary p-5 text-white shadow-soft sm:p-8">
          ...
          <div class="mt-auto pt-6">
            <a
              ...
              class="inline-flex items-center gap-2 rounded-[5px] bg-surface px-5 py-3 font-body-sm text-sm font-bold text-primary transition-[opacity,transform] hover:opacity-90 active:scale-95"
            >
        ...
        <article
          ...
          class="glass-edge-grey flex flex-col rounded-[5px] bg-surface-container-high p-5 shadow-soft sm:p-6"
        >
        ...
        <div class="flex flex-col gap-gutter">
          <article
            ...
            class="glass-edge-grey flex flex-1 flex-col rounded-[5px] bg-surface-container-high p-5 shadow-soft"
          >
