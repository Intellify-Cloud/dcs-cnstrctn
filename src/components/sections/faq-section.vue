...
<template>
  <section id="faq" v-reveal class="px-margin-mobile py-stack-lg sm:px-margin-large-mobile md:px-margin-tablet lg:px-margin-desktop" aria-labelledby="faq-heading">
    <div
      class="mx-auto max-w-container-max rounded-[5px] bg-primary px-margin-mobile py-14 md:px-16 md:py-20"
    >
      <div class="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1.4fr]">
        ...
        <div class="flex flex-col gap-4">
          <div
            ...
            :key="item.question"
            class="faq-item rounded-[5px] border brass-border bg-surface px-6 py-5 shadow-soft"
